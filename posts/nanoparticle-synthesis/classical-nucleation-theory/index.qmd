...
|---|:---:|:---:|:---:|
| Free energy $\Delta G_T$ | $\tfrac{4}{3} \pi r^3 \Delta g_v + 4 \pi r^2 \gamma$ | $-\frac{4 \pi \rho \hat{q}_f}{3 T_s} \Delta T r^3 + 4 \pi r^2 \gamma$ | $-\frac{k_B T}{v_m}\ln S + 4 \pi r^2 \gamma$ |
